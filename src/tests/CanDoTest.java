...
public class CanDoTest
{
    ...
    {
        initializeFull();
        TurnTracker tt = f.gettheGameMap().getTt();
        tt.setCurrentPlayer(1);
        f.gettheGameMap().setTt(tt);
    ...
    {
        initializeFull();
        TurnTracker turnTracker = f.gettheGameMap().getTt();
        turnTracker.setCurrentPlayer(1);
        f.gettheGameMap().setTt(turnTracker);
    ...
    public void testCanDiscardCards()
    {
        ...
        f.gettheGameMap().getPlayers().get(0).setResources(emptyList);
        assert(!f.canDiscardCards(0,resourceList));
    ...
    public void canUseYearOfPlenty()
    {
        ...
        turnTracker.setCurrentPlayer(1);
        f.gettheGameMap().setTt(turnTracker);
        f.gettheGameMap().getPlayers().get(1).getOldDevCards().setYearOfPlenty(5);
        assert(f.canYearOfPlenty(1));
        assert(!f.canYearOfPlenty(0));

        f.gettheGameMap().getPlayers().get(0).getOldDevCards().setYearOfPlenty(0);
        turnTracker.setCurrentPlayer(0);
        f.gettheGameMap().setTt(turnTracker);
        assert(!f.canYearOfPlenty(0));
    ...
    public void canUseRoadBuilding()
    {
        ...
        turnTracker.setCurrentPlayer(1);
        f.gettheGameMap().setTt(turnTracker);
        f.gettheGameMap().getPlayers().get(1).getOldDevCards().setRoadBuilding(5);
        assert(f.canRoadBuilding(1));
        assert(!f.canRoadBuilding(0));

        turnTracker.setCurrentPlayer(0);
        f.gettheGameMap().getPlayers().get(0).getOldDevCards().setRoadBuilding(0);
        f.gettheGameMap().setTt(turnTracker);
        assert(!f.canRoadBuilding(0));
    ...
    public void canUseSoldier()
    {
        ...
        turnTracker.setCurrentPlayer(1);
        f.gettheGameMap().setTt(turnTracker);
        f.gettheGameMap().getPlayers().get(1).getOldDevCards().setSoldier(5);
        assert(f.canPlaySoldier(1));
        assert(!f.canPlaySoldier(0));

        turnTracker.setCurrentPlayer(0);
        f.gettheGameMap().getPlayers().get(0).getOldDevCards().setSoldier(0);
        f.gettheGameMap().setTt(turnTracker);
        assert(!f.canPlaySoldier(0));
    ...
    public void canUseMonopoly()
    {
        ...
        turnTracker.setCurrentPlayer(1);
        f.gettheGameMap().setTt(turnTracker);
        f.gettheGameMap().getPlayers().get(1).getOldDevCards().setMonopoly(5);
        assert(f.canMonopoly(1));
        assert(!f.canMonopoly(0));

        turnTracker.setCurrentPlayer(0);
        f.gettheGameMap().getPlayers().get(0).getOldDevCards().setMonopoly(0);
        f.gettheGameMap().setTt(turnTracker);
        assert(!f.canMonopoly(0));
    ...
    public void canUseMonument()
    {
        ...
        turnTracker.setCurrentPlayer(1);
        f.gettheGameMap().setTt(turnTracker);
        f.gettheGameMap().getPlayers().get(1).getOldDevCards().setMonument(5);
        assert(f.canUseMonument(1));
        assert(!f.canUseMonument(0));

        turnTracker.setCurrentPlayer(0);
        f.gettheGameMap().getPlayers().get(0).getOldDevCards().setMonument(0);
        f.gettheGameMap().setTt(turnTracker);
        assert(!f.canUseMonument(0));
